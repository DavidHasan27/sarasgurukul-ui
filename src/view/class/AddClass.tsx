...
const AddClass = () => {
  ...
  const [classIdentity, setClassIdentity] = useState<any>();
  ...
  const onSubmitSchool = () => {
    ...
    if (!classIdentity) {
      setclassIdentityError("Please select class identity");
      isError = true;
    }
      ...
      <div className="w-full h-screen overflow-x-hidden border-t flex flex-col">
        <main className="w-full flex-grow p-6">
          <span>
            ...
            <h1 className="w-full text-3xl text-black pb-6">Add New Class</h1>
          </span>
              ...
              <div className="leading-loose">
                <form className="p-10 bg-white rounded shadow-xl min-h-[270px]">
                  ...
                  <div className="">
                    ...
                    <Select1
                      name="class"
                      placeholder="Select Class Identity"
                      options={CLASS_IDENTITY}
                      ...
                      classNamePrefix="Select Class Identity"
                      onChange={(event) => {
                        setClassIdentity(event);
                      }}
                      value={classIdentity}
                      isDisabled={!school}
                    />
