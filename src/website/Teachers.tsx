    ...
    <>
      ...
      <div className="container-fluid pt-5">
        ...
        <div className="container">
          <div className="text-center pb-2">
            <p className="section-title px-5">
              <span className="px-2">Our Doctors</span>
            </p>
            ...
            <div className="col-md-6 col-lg-3 text-center team mb-5">
              ...
              >
                ...
                <Popover open={openPopover2} handler={setOpenPopover2}>
                  ...
                  <SGTeamInfopopup
                    name={"Dr. Pradnya Khare"}
                    src={"img/team-3.jpg"}
                    desc={`Dr. Pradnya Khare is a Pediatric Dentist in Pimple Gurav, Pune and has an experience of 24 years in this field. Dr. Pradnya Khare practices at Khare Dental Home in Pimple Gurav, Pune. She completed BDS from Nair Hospital Dental College (NHDC), Mumbai in 2000 and MDS - Paedodontics And Preventive Dentistry from Mahatma Gandhi Dental College in 2016.

                    She is a member of ISPPD and ida. Some of the services provided by the doctor are: Dental Examinations,Pulpectomy,Dental Checkup (General),Crowns and Bridges Fixing and Orthodontic Treatment etc. `}
                  />
                </Popover>
              </div>
              <h4>Dr. Pradnya Khare</h4>
              <i>Consultant Pediatric Dentist</i>
            </div>
            <div className="col-md-6 col-lg-3 text-center team mb-5">
              <div
                className="position-relative overflow-hidden mb-4"
              ...
              >
                ...
                <Popover open={openPopover1} handler={setOpenPopover1}>
                  ...
                  <SGTeamInfopopup
                    name={"Dr.Amit R Manure"}
                    src={"img/team-4.jpg"}
                    desc={`Practicing as General physician since 16 yrs.
                    Director at Shree Clinic, Hinjawadi.
                    Medical officer in, Marathwada Mitra Mandal Pharmacy college,Kalewadi
                    Marathwada Mitra Mandal Polytechnic college,Kalewadi
                    Modern college of Pharmacy, Nigdi
                    Yoga Evaluator 
                    Govt.Medical officer, Pune`}
                  />
                </Popover>
              </div>
              <h4>Dr.Amit R Manure</h4>
              <i>Yoga Evaluator</i>
            </div>
            {/* <div className="col-md-6 col-lg-3 text-center team mb-5">
              <div
